...
// import { numberFormatter, percentageFormatter } from "../utils/numberFormatters"
...
function Wallet() {
  return (
    <section className="w-[80%] h-full flex flex-col mt-16 mb-24 relative">
      <div className="w-full min-h-[60vh] py-8 flex flex-wrap justify-evenly  border border-gray-100 rounded"></div>
    </section>
  )
}
